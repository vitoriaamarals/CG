...
VART::Transform::Transform(TypeID type)
{
    if (type != IDENTITY)
        throw logic_error("Incorrect use of Transform constructor");
    MakeIdentity();
}

VART::Transform::Transform(TypeID type, double x, double y, double z)
{
    switch (type)
    {
        case TRANSLATION:
...
VART::Transform::Transform(TypeID type, double radians)
{
    switch (type)
    {
        case X_ROTATION:
...
VART::Transform VART::Transform::Translation(double tx, double ty, double tz)
{
    Transform result;
    result.MakeTranslation(tx, ty, tz);
    return result;
}

VART::Transform VART::Transform::Translation(const Point4D v)
{
    Transform result;
    result.MakeTranslation(v);
    return result;
}

VART::Transform VART::Transform::XRotation(double radians)
{
    Transform result;
    result.MakeXRotation(radians);
    return result;
}

VART::Transform VART::Transform::YRotation(double radians)
{
    Transform result;
    result.MakeYRotation(radians);
    return result;
}

VART::Transform VART::Transform::ZRotation(double radians)
{
    Transform result;
    result.MakeZRotation(radians);
    return result;
}

VART::Transform VART::Transform::Scale(double sx, double sy, double sz)
{
    Transform result;
    result.MakeScale(sx, sy, sz);
    return result;
}

VART::Transform VART::Transform::Identity()
{
    Transform result;
    result.MakeIdentity();
    return result;
...
ostream& operator<<(ostream& output, const VART::Transform& t)
{
    int i, j;
