...
std::ostream& operator<<(std::ostream& output, const VART::Transform& t);
...
/// away from root) is the one applied first.
    class Transform : public SceneNode {
        ...
        public:
            enum TypeID { IDENTITY, TRANSLATION, SCALE, SHEAR, X_ROTATION,
                          Y_ROTATION, Z_ROTATION, VEC_ROTATION, ROTATION };
            ...
            Transform(TypeID type);

            /// \brief Creates a translation or scale transform.
            Transform(TypeID type, double x, double y, double z);

            /// \brief Creates a rotation around one of the predefined axis.
            Transform(TypeID type, double radians);
            ...
            virtual SceneNode::TypeID GetID() const { return TRANSFORM; }
        ...
        // PUBLIC STATIC METHODS
            /// Translation named constructor.
            static Transform Translation(double tx, double ty, double tz);
            /// Translation named constructor.
            static Transform Translation(const Point4D v);
            /// Rotation named constructor.
            static Transform XRotation(double radians);
            /// Rotation named constructor.
            static Transform YRotation(double radians);
            /// Rotation named constructor.
            static Transform ZRotation(double radians);
            /// Scale named constructor.
