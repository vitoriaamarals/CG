...
/// class slowly substitutes the other two.
    class Point4D {
        ...
        // PUBLIC METHODS
            ...
            /// \brief Returns a std::string representation of the data.
            /// \return A std:string of the coordinates formated as "(x, y, z, w)".
            std::string AsString(int precision=5) const;
